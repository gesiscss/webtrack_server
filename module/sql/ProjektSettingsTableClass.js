...
module.exports = class ProjektSettingsTableClass extends Core{
  ...
  constructor() {
    super();
    this.table = "project";
    this.COLUMN = ['ACTIVE', 'ENTERID', 'CHECK_CLIENTIDS', 'SENDDATAAUTOMATICALLY', 'PRIVATEBUTTON', 'SHOWHISTORY', 'EDITHISTORY', 'SHOW_DOMAIN_HINT', 'ACTIVE_URLLIST', 'URLLIST_WHITE_OR_BLACK', 'EXTENSIONSFILTER', 'FORGOT_ID', 'PRIVATETAB'];
